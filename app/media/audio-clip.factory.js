...
*/
require('angular').module('pulsar.media').factory('media.AudioClip', [
    'media.const.Type',
    'media.const.State',
    'audio.DataUtils',
    '$q',
...
function _Clip(MediaType, MediaState, DataUtils, $q, IPlayable) {
    ...
    AudioClip.autoIncrementId = parseInt(localStorage.getItem(AudioClip._IdKey), 10) || 0;
